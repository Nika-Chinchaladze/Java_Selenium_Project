...
public class SelectMenuTest extends BaseTest {
    ...
    public void testSelectDeSelectVerify() {
        ...
        assertTrue(selectMenuPage.assertions.verifyDropDownSelectedElement(selectMenuPage.multiSelect, "Opel"));
        selectMenuPage.actions.deSelectByVisibleText(selectMenuPage.multiSelect, "Opel");
        assertFalse(selectMenuPage.assertions.verifyDropDownSelectedElement(selectMenuPage.multiSelect, "Opel"));
